...
for i=1:L
    temp = 0.0; % initialization sum of probability to zero

    for j=1:i
    temp = temp + prb(j); % add probability 
    end

    temp = round(L*(temp)); % get pixel value that result of histogram equalization 
end
